...
class RockPaperScissors:
    ...
    class Movable:
        ...
        def __init__(self, team_size: int, team: str = 'Rock' or 'Paper' or 'Scissors'):
            self.name = team
    ...
    def create_widgets(self):
        ...
        setup_button = Button(self.interface_frame, text='Set up',
                              highlightbackground=RockPaperScissors.INTERFACE_BG_COLOR)
        ...
        guess_label = Label(self.interface_frame, text='No guess made.',
                            bg=RockPaperScissors.INTERFACE_BG_COLOR, fg='black')
    ...
    def collision(self, obj1, object_ID2):
        ...
        if obj1.get_type() == 'Rock' and obj2.get_type() == 'Paper':
            winner = obj2
            ...
            obj1.set_type('Paper', self.team_size.get())
        elif obj1.get_type() == 'Rock' and obj2.get_type() == 'Scissors':
            winner = obj1
            ...
            obj2.set_type('Rock', self.team_size.get())
        elif obj1.get_type() == 'Paper' and obj2.get_type() == 'Rock':
            winner = obj1
            ...
            obj2.set_type('Paper', self.team_size.get())
        elif obj1.get_type() == 'Paper' and obj2.get_type() == 'Scissors':
            winner = obj2
            ...
            obj1.set_type('Scissors', self.team_size.get())
        elif obj1.get_type() == 'Scissors' and obj2.get_type() == 'Rock':
            winner = obj2
            ...
            obj1.set_type('Rock', self.team_size.get())
        elif obj1.get_type() == 'Scissors' and obj2.get_type() == 'Paper':
            winner = obj1
            ...
            obj2.set_type('Scissors', self.team_size.get())
        else:
            winner = None
